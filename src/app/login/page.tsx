...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("demo@premiumcapital.app");
  ...
  return (
    <Wrapper>
      <Card onSubmit={handleLogin}>
        <LogoBox>
          <img src="images/logo2.jpeg" alt="logo" width="60" />
          <Title>User Login</Title>
        </LogoBox>

        <DemoNotice>
          ℹ️<strong>Demo Access:</strong> Click <b>Sign in</b> to explore the
          app using a prefilled demo admin account.
        </DemoNotice>
        ...
        <Footer>© 2025 Premium Capital. All Rights Reserved.</Footer>
      </Card>
    </Wrapper>
  );
}
